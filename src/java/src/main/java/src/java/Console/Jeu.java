...
public class Jeu {  // 17/03/23  // 18/03/23  // 20/03/23  // 21/03/23  // 24/03/23   // 25/03/23
    ...
    public static void hpBuff(Wizard wizard) {
        wizard.setHealth((float) (wizard.getHealthMax() * 1.1));
    }
    ...
    public static void main(String[] args) {
        ...
        boss.add(new Boss("Rogue", 500, 500, 100, null, null));
        boss.add(new Boss("Lestrange", 100, 1000, 50, null, null));
        boss.add(new Boss("Voldemort", 100, 500, 50, null, null));
        ...
        int randomSize = (int) (Math.random() * 18) + 8;
        ...
        System.out.println("Welcome to Poudlard " + playerName + ".");
        promptEnterKey();
